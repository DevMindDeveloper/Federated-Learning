...
# dataset_path = "dataset_2/trainingSet"
...
for comm_round in range(comms_round):
    ...
    for client in clients_names:
        ...
        lm_enc_weights = encrypt_parameter(local_model, context)
        # lm_weights_encrypted = ts.ckks_vector(context, lm_weights)

        weight_factor = weight_scaling_factor(clients_batchset, client)
        scaled_weight = sacling_weight(lm_enc_weights, weight_factor)
